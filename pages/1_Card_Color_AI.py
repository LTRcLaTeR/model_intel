...
with tab_article:
    ...
    st.markdown("""
    ไปที่แท็บ **🚀 ใช้งานโมเดล** แล้วทำตามขั้นตอนดังนี้:
    """)
    st.markdown("##### ✅ วิธีที่ 1 — อัปโหลดรูปเอง")
    st.markdown("""
    1. เปิดเว็บไซต์ [bangbon.app](https://bangbon.app/) แล้วหารูปการ์ดที่ต้องการ
    2. บันทึกรูปภาพลงเครื่อง (รองรับไฟล์ `.jpg`, `.jpeg`, `.png`)
    3. กดปุ่ม **Browse files** แล้วเลือกไฟล์รูปที่บันทึกไว้
    4. โมเดลจะทำนายสีของการ์ดและแสดงผลทันที
    """)
    st.markdown("##### ✅ วิธีที่ 2 — ใช้ตัวอย่างการ์ดสำเร็จรูป")
    st.markdown("""
    1. เลื่อนลงมาที่ส่วน **🃏 ตัวอย่างการ์ดแต่ละสี**
    2. กดปุ่ม **ทำนาย** ใต้รูปการ์ดสีที่ต้องการทดลอง
    3. โมเดลจะแสดงผลการทำนายสีของการ์ดนั้นทันที
    """)
    st.info("💡 ควรใช้รูปการ์ดที่เห็นมุมขวาบนชัดเจน เนื่องจากโมเดลเรียนรู้จากบริเวณนั้นเป็นหลัก")
